...
# model
class PatchUnet3DFiLM(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        cond_emb_list = [t, patch_pos_emb, guidance_emb]
        ...
        cond_emb_list = [emb for emb in cond_emb_list if emb is not None]
        t = torch.cat(cond_emb_list, dim=-1)
