...
pretrained_unet_path="/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/E2_pLDM_UNET3D_encoder/checkpoint-80000"
...
output_dir="/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/patch_generation/encoder_500"
axis="c"
seed=42
...
temp_dir = "/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/patch_generation/encoder_tmp_slices"
...
with torch.no_grad():
    for i in range(num_samples):
        ...
        for j in range(27):
            ...
            #gen_slice_images[0].save(f"{output_dir}/encoder_patch_{j}_gen1_temp.gif", save_all=True, append_images=gen_slice_images[1:], duration=200, loop=0)
            
            torch.save(image.cpu(), f"{output_dir}/encoder_patch_{j}_gen1_tensor_temp.pth")
