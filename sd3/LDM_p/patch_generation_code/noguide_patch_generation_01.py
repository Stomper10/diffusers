...
with torch.no_grad():
    for i in range(num_samples):
        ...
        for j in range(27):
            ...
            gen_slice_images[0].save(f"{output_dir}/noguide_patch_{j}_gen01.gif", save_all=True, append_images=gen_slice_images[1:], duration=200, loop=0)
            
            torch.save(image.cpu(), f"{output_dir}/noguide_patch_{j}_gen01_tensor.pth")
