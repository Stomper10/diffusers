...
with torch.no_grad():
    for i in range(num_samples):
        ...
        for j in range(27):
            ...
            image = torch.load("/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_w/results/low-res_gen/tensor_low-res_image.pth").to(torch.float64).to(unet3d.device)
            print(image.shape)
            ...
            torch.save(image.cpu(), f"{output_dir}/concat_patch_{i+500}_{j}_gen1_tensor.pth")
