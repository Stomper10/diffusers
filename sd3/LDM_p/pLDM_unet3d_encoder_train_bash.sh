...
export JOB_NAME="test_pLDM_UNET3D_encoder"
export VAE_PATH="/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/E0_pLDM_VQGAN3D/checkpoint-120000"

accelerate launch --config_file /shared/s1/lab06/wonyoung/diffusers/sd3/config/config_single.yaml \
    /shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/train_unet3d_encoder.py \
