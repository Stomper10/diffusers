...
export JOB_NAME="test_pLDM_UNET3D_contorl"
export VAE_PATH="/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/E1_pLDM_VQGAN3D/checkpoint-770000"
export UNET_PATH="/shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/results/E1_pLDM_UNET3D_naive/checkpoint-320000"

accelerate launch --config_file /shared/s1/lab06/wonyoung/diffusers/sd3/config/config_single.yaml \
    /shared/s1/lab06/wonyoung/diffusers/sd3/LDM_p/train_unet3d_control.py \
